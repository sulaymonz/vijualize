          ...
          <div className="absolute w-[80%] h-[10%] top-[20%] left-[10%] flex flex-row font-mono">
            ...
            <div className="flex flex-col justify-end font-sans">
              <div className="text-[7px] p-[10px] leading-none">
                The future isn't coming — it's already here. Slip into these
                shoes and experience tomorrow while you're living for today. An
                evolution of the acclaimed '80s runner, these sneakers have an
                upper as airy as it is futuristic. Overlays lend a cyberpunk
                vibe, while the outsole stays confidently ahead of its time. Yet
                for all their forward-thinking style, these shoes keep comfort
                close.
              </div>
            </div>
          </div>
