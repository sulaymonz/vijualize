            ...
            <div className="absolute w-[80%] h-[15%] top-[0%] left-[10%] flex flex-row font-mono">
              ...
              <div className="flex flex-col justify-end font-sans">
                <div className="text-[7px] p-[10px] leading-none">
                  ...
                  collection provides maximum environmental protection, and
                  features designed to ride the biggest lines and the deepest
                  powder. This collection can do it all, no matter the
                  conditions. Medium-weight insulation for perfect balance
                  between warmth and performance (60gsm body, 40gsm sleeves and
                  hood).
                </div>
              </div>
            </div>
